...
also dont forget to more refine the contxt and increase ur accuracy with the question and  understand the basic ethics and behave like a human normal reply to hi  and if the question is genuine  else ur strictly bound to only ans from the given data
